...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(1200px_circle_at_top,_#fff7ed,_#ecfeff_45%,_#f1f5f9_100%)] px-6 py-16">
        ...
        <div className="rounded-3xl border border-slate-200/70 bg-white/90 p-8 shadow-[0_24px_60px_-40px_rgba(15,23,42,0.45)] backdrop-blur">
          <div className="space-y-3">
            ...
            <p className="text-sm text-slate-600">
              Use your account credentials to continue into chat.
            </p>
          </div>
